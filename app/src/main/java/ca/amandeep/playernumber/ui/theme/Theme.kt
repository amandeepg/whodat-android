...
val PlayerNumberLightColorScheme = lightColorScheme(
    primary = ACCENT_RED,
...
val PlayerNumberDarkColorScheme = darkColorScheme(
...
private fun googleSansFlexFamilyFor(width: FontWidth): FontFamily = when (width) {
...
val PlayerNumberTypography = Typography(
